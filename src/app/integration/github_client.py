...
class GithubService:
    ...
    def get_pr_files(self, repo_name: str, pr_number: int):
        ...
        try:
            ...
            logger.info(f"File: {__file__} | Successfully fetched files for pull request #{pr_number} from repository {repo_name}.")
            return files_data
    ...
    def combine_diffs(self, files):
        ...
        try:
            ...
            logger.info(f"File: {__file__} | Successfully combined diffs for pull request files.")
